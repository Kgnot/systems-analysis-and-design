...
\usetikzlibrary{positioning, arrows.meta, shapes.misc, shapes.geometric}
...
\begin{figure}[h]
    ...
    \node[box, right=of ingestion] (preparation) {Data Preparation};
    \node[box, right=of preparation] (training) {Model Training};
    \node[box, right=of training] (inference) {Model Inference};
    \node[box, right=of inference] (submission) {Submission Generator};
    \draw[arrow] (ingestion) -- (preparation);
    \draw[arrow] (preparation) -- (training);
    \draw[arrow] (training) -- (inference);
    \draw[arrow] (inference) -- (submission);
    \draw[thick] ([yshift=-1cm]ingestion.south west) -- ([yshift=-1cm]submission.south east);
    \fill[white, draw=black] ([yshift=-1cm]ingestion.south west) circle (2pt);
    \fill[white, draw=black] ([yshift=-1cm]$(ingestion)!0.5!(submission)$) circle (2pt);
    \fill[white, draw=black] ([yshift=-1cm]submission.south east) circle (2pt);
    \end{tikzpicture}
    }
